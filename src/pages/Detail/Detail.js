            ...
            >
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-4 flex flex-col items-center">
                        <h1 style={{ color: '#E5C755', fontWeight: 'bold', fontSize: 15, backgroundColor: 'rgba(0,0,0,0.5)', borderRadius: '10px', padding: '10px' }}>Đánh giá</h1>
                        <h1 className="text-2xl"><Rate allowHalf value={filmDetail.danhGia / 2} style={{ color: '#E5C755', fontSize: 30 }} /></h1>
                                                        ...
                                                        <div key={index}>
                                                            ...
                                                            <div className="thong-tin-lich-chieu grid grid-cols-4 mt-5">
                                                                {cumRap.lichChieuPhim?.slice(0,12).map((lichChieu,index)=>{
                                                                    return (
                                                                        <NavLink to="/contact" className="col-span-1" key={index} style={{fontSize:'15px',color:'#1890FF'}}>
