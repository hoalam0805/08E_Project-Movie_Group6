        ...
        <div>
            ...
            <div className="grid grid-cols-6">
                ...
                <div className="divide-y divide-coolGray-700">
                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                        ...
                        {mangDanhMuc.map((danhMuc,index) => {
                            ...
                            return (
                            <li className="dark:bg-coolGray-800 dark:text-coolGray-50" key={index} onClick={() => {
                ...
                <div className="col-span-5">
                    <h3 className="text-center text-purple-200 text-8xl mt-5">Menu</h3>
                                    ...
                                    return (
                                        <div class="p-4 lg:w-1/3" key={index}>
                                            <div class="h-full bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">{item.maDanhMuc}</h2>
                                                ...
                                                <div class="text-right leading-none flex justify-end absolute bottom-0 left-0 w-full">
                                                    <span class="text-gray-400 mr-3 inline-flex items-center leading-none text-xl pr-3">
                                                        Giá: {item.gia}
                                                    </span>
                                                </div>
                                            </div>
